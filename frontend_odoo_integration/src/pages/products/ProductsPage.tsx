        ...
        <div className="bg-white p-4 rounded-xl shadow-sm border mb-4">
          ...
          >
            ...
            <button
              ...
              className="col-span-3 bg-green-600 text-white py-2 rounded-lg hover:bg-green-700 disabled:opacity-50"
            >
            ...
            <tbody>
              {data?.items?.map((p: any) => (
                <tr key={p.id} className="border-t hover:bg-gray-50">
                  ...
                  <td className="px-4 py-3 text-right">${p.list_price?.toFixed(2)}</td>
              ...
              {!data?.items?.length && (
                <tr>
                  <td colSpan={5} className="px-4 py-8 text-center text-gray-400">
                    No products found. Connect to Odoo to see products.
                  </td>
                </tr>
              )}
            </tbody>
